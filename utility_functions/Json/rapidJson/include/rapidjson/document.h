...
public:
	...
	*/
	...
	inline bool IsNull()   const { return flags_ == kNullFlag; }
	inline bool IsFalse()  const { return flags_ == kFalseFlag; }
	inline bool IsTrue()   const { return flags_ == kTrueFlag; }
	inline bool IsBool()   const { return (flags_ & kBoolFlag) != 0; }
	inline bool IsObject() const { return flags_ == kObjectFlag; }
	inline bool IsArray()  const { return flags_ == kArrayFlag; }
	inline bool IsNumber() const { return (flags_ & kNumberFlag) != 0; }
	inline bool IsInt()	   const { return (flags_ & kIntFlag) != 0; }
	inline bool IsUint()   const { return (flags_ & kUintFlag) != 0; }
	inline bool IsInt64()  const { return (flags_ & kInt64Flag) != 0; }
	inline bool IsUint64() const { return (flags_ & kUint64Flag) != 0; }
	inline bool IsDouble() const { return (flags_ & kDoubleFlag) != 0; }
	inline bool IsString() const { return (flags_ & kStringFlag) != 0; }

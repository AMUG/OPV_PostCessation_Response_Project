...
text(0.35, -4.59, '\lambda = 60 days');
text(0.35, -4.79, '\lambda = 150 days');
myprint('-dpng', 'figures\Fig_rate_new.png');
myprint('-dtiff', 'figures\Fig_rate_new.tiff');
saveas(gcf, 'figures\Fig_rate_new.fig');
end
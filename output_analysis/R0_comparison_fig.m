...
plot([0.1, 0.3], [-4.2, -4.2], '-', 'Color', colors(1, :));
plot([0.1, 0.3], [-4.4, -4.4], '-', 'Color',colors(2, :));
plot([0.1, 0.3], [-4.6, -4.6], '-', 'Color',colors(3, :));
plot([0.1, 0.3], [-4.8, -4.8], '-', 'Color',colors(4, :));

plot([0.90, 1.15], [-4.2, -4.2], 'k-');
plot([0.90, 1.15], [-4.4, -4.4], 'k--', 'LineWidth', 4);
text(0.35, -4.22, 'R_{0f} = 1.2');
text(0.35, -4.42, 'R_{0f} = 1.5');
text(0.35, -4.62, 'R_{0f} = 2');
text(0.35, -4.82, 'R_{0f} = 3');
text(1.2, -4.19, 'g = 0.5');
text(1.2, -4.39, 'g = 0.25');


%mylegend('R_{0f} = 1.2', 'R_{0f} = 1.5', 'R_{0f} = 2', 'R_{0f} = 3', 'Location', 'Southwest');
myprint('-dpng', 'figures\FigR0_new.png');
myprint('-dtiff', 'figures\FigR0_new.tiff');
saveas(gcf, 'figures\FigR0_new.fig');
end
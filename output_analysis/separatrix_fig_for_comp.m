function [] = separatrix_fig_for_comp()
...
cl = colorbar;
title('9 months of persistence required');
set(get(cl, 'YLabel'), 'string', 'OPV2 survival probability');
myprint('-dpng', 'figures\Fig1_forcomp.png');
myprint('-dtiff', 'figures\Fig1_forcomp.tiff');
saveas(gcf, 'figures\Fig1_forcomp.fig');
end